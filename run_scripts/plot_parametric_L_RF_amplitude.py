...
###########################
amplitude_suffix = ' 50kV/m'
linewidth = 2

# # set1, Rm=3, l=1m, ERF=50kV/m, omega/omega0T=1.679, k/2pi=-3
# set_num = 1
# set_name_list += [str(set_num) + ' (D)' + amplitude_suffix]
...
# set_name_list += [str(set_num) + ' (T)' + amplitude_suffix]
